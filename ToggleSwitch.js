...
class ToggleSwitch extends React.Component {
  ...
  componentDidUpdate (previousProps) {
    if (previousProps.isOn !== this.props.isOn && this.props.isOn !== this.state.isOn) {
      this.makeToggleAnim(this.props.isOn)
    }
  }

  onToggle = () => {
    this.makeToggleAnim(!this.state.isOn)
  }

  makeToggleAnim = (isOn) => {
    let toValue = isOn ? 1 : 0
